...
async function extractQuestionsFromText(text, fallbackLog = null) {
...
async function extractQuestionsFromPdfBuffer(buffer, fallbackLog = null) {
  const text = await extractFullText(buffer);
  return extractQuestionsFromText(text, fallbackLog);
}

async function extractQuestionsFromPlainTextBuffer(buffer, fallbackLog = null) {
  return extractQuestionsFromText(buffer.toString('utf-8'), fallbackLog);
}
