...
// closest available mark, a plain filled dot. ♤ ♧ ☆ have no reasonable
// text substitute (no bundled font has any card-suit or star glyph at
// all), so instead of a substitution they're drawn as small inline
// vector icons — see drawVectorGlyph() below, the same technique this
// file already uses for the how-to legend's icons (see file header).
