  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      results.forEach((r, idx) => {
        ...
        // deliberately distinct from the pure-white page background this
        // design draws on) with a thin neutral border, no rounding — plus
        // the colored left accent bar that replaces design_1's filled
        // cream background as the "this is one card" visual cue.
