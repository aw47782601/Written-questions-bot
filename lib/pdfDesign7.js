...
// very bottom, with just a bold page number centered on it. The
// reference sheet's footer carries no book-name/brand text at all, so
// (unlike design_6) bookName/footerBrand are not drawn — accepted only
// for call-site signature parity.
